------------------------------------------------
-- File:   xmonad.hs   XMonad configuration file
...
-- Workspaces
--
myWorkspaces    = ["1-main","2-dev","3-mail","4-chat"] ++ map show [5..7] ++ ["8-music","9-web"]


-- Border colors for unfocused and focused windows
--
myNormalBorderColor  = "#707880"
...
myPP = xmobarPP { ppCurrent = xmobarColor "#8C9440" "" . wrap "[" "]"
                --, ppHidden = xmobarColor "#000000" ""
                , ppHiddenNoWindows = xmobarColor "#707880" ""
                , ppUrgent = xmobarColor "#000000" "" . wrap "<" ">"
                , ppLayout = xmobarColor "#c5c8c6" "" . wrap "[" "]"
                , ppTitle = xmobarColor "#c5c8c6" "" .wrap "[" "]" . shorten 60
                , ppSep = " :: "   
                }
